...
class GumbleGmvaeNetLossNet(GmvaeNetLossNetBase):
    class Input(tf.experimental.ExtensionType, ExtensionTypeIterableMixin, GumbleGmvaeTypeGetter):
        py: tf.Tensor
    ...
    class Output(GmvaeNetLossNetBase.Output, GumbleGmvaeTypeGetter):
        ...
