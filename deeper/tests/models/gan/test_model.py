...
CONFIGS = [
    Gan.Config(descriminator=desciminatorConfig, generator=config0),
    Gan.Config(descriminator=desciminatorConfig, generator=config1),
    Gan.Config(descriminator=desciminatorConfig, generator=config2),
]
EXPECTED_TYPES = [
    ...
    # Test without feeding temperature
    (GumbleGmvaeNet, GumbleGmvaeNetLossNet, GumbleGmvaeLatentParser),
]
...
class TestGanModel(unittest.TestCase):
    def setUp(self):
        ...
        self.models = [Gan(c) for c in CONFIGS]
