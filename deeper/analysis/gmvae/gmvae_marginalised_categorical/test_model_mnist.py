...
from deeper.models.gmvae.gmvae_marginalised_categorical.utils import chain_call, purity_score
...
with tf.device('/gpu:0'):
    train(m1, X_train, y_train, X_test, y_test, num=100, epochs=10, iter=500, verbose=1)
